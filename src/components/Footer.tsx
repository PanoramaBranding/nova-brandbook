...
export default function Footer({
  ...
  return (
    <footer
      className={`flex flex-col items-start md:flex-row md:items-center gap-[120px] md:gap-3 pt-16 md:pt-[140px] pb-8 md:pb-[38px] px-4 md:pl-[67px] md:pr-[38px] md:max-w-[1240px] ${
