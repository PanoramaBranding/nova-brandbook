...
export default function EstrategiaPage() {
  return (
    <div className="flex flex-col">
      ...
      <section id="brand-tree" className="px-4 md:pl-[67px] md:pr-[38px] md:max-w-[1240px] pb-16 md:pb-24 scroll-mt-8">
      ...
      {STAGES.map((stage) => (
        <section
          key={stage.id}
          id={stage.id}
          className="px-4 md:pl-[67px] md:pr-[38px] md:max-w-[1240px] pb-16 md:pb-24 scroll-mt-8 border-t border-azul-1 pt-12"
        >
      ...
      <section className="px-4 md:pl-[67px] md:pr-[38px] md:max-w-[1240px] pb-16 md:pb-24 border-t border-azul-1 pt-12">
